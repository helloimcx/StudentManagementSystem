...
function entryStuBasicInfo(numsOfRow) {
	...
	var editDiv = document.getElementById("editMsg");
		...
		for(var i=0;i<numsOfRow-differ;i++) {
			...
			//第十列
			var TdObj10 = TrObj.insertCell(8);
			...
			//第十一列
			var TdObj11 = TrObj.insertCell(9);
...
schooling.name="eduBackground"
			...
			//第十二列
			var TdObj12 = TrObj.insertCell(10);
			...
			//第十三列
			var TdObj13 = TrObj.insertCell(11);
			...
			//第十三列
			var TdObj14 = TrObj.insertCell(12);
