# Generated by Django 2.0.7 on 2020-05-10 15:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='teacherNo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MainApp.TecInfo', verbose_name='教师编号'),
        ),
        migrations.AddField(
            model_name='teacherpurview',
            name='teacherNo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MainApp.TecInfo', verbose_name='教师编号'),
        ),
        migrations.AddField(
            ...
            name='student',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='MainApp.StuInfo', verbose_name='关联学生'),
        ),
        migrations.AddField(
            model_name='passwordresettoken',
            name='teacher',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='MainApp.TecInfo', verbose_name='关联教师'),
        ),
    ]
